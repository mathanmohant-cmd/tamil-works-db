...
# -*- coding: utf-8 -*-
"""
Delete Saiva Prabandha Malai works and collection
...
def delete_saiva_prabandha_malai(connection_string):
    """Delete all Saiva Prabandha Malai works and collection"""
    print("\n" + "="*70)
    print("  DELETE SAIVA PRABANDHA MALAI")
    print("="*70)
    ...
    try:
        ...
        if work_count == 0:
            print("\n✗ No Saiva Prabandha Malai works found")
            return False
        ...
        print("\nDeleting Saiva Prabandha Malai data...")
...
def main():
    ...
    if delete_saiva_prabandha_malai(db_connection):
        print("\n✓ Deletion complete")
        sys.exit(0)
    else:
        print("\n✗ Deletion failed")
