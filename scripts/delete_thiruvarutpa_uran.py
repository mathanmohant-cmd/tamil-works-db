...
# -*- coding: utf-8 -*-
"""
Delete Thiruvarutpa - Uran Adigal Edition

This script deletes:
- Thiruvarutpa - Uran Adigal Edition (திருவருட்பா - ஊரன் அடிகள் பதிப்பு)

Usage:
    python delete_thiruvarutpa_uran.py [database_url]
"""
...
def delete_thiruvarutpa_uran(connection_string):
    """Delete Thiruvarutpa Uran Adigal Edition"""
    print("\n" + "="*70)
    print("  DELETE THIRUVARUTPA - URAN ADIGAL EDITION")
    print("="*70)
    ...
    try:
        ...
        if not works:
            print("\n✗ Thiruvarutpa Uran Adigal Edition not found")
            return False
...
def main():
    ...
    if delete_thiruvarutpa_uran(db_connection):
        print("\n✓ Deletion complete")
        sys.exit(0)
    else:
        print("\n✗ Deletion failed")
