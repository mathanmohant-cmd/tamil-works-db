...
WORK_METADATA = {
    ...
    36: {
        'work_name': 'Valmiki Soothiram',
        'work_name_tamil': 'வால்மீகர் சூத்திரம்',
        ...
        'file': '36 வால்மீகர் சூத்திரம்.txt',
        'description': 'Aphorisms (soothiram) of Tamil Siddha wisdom attributed to the legendary Valmiki'
    }
}

# Verse tag patterns: These ** markers are verse tags, not section markers
# Rule: If a ** appears in the middle of verses (not at the beginning before any #N),
#       it's a verse tag for the NEXT verse
#
# Verse tags include:
# 1. Deity invocations: துதி, காப்பு, வாழ்த்து
# 2. Poetic forms: விருத்தம், கலித்துறை, கொச்சகம், வெண்பா
# 3. Special wisdom categories: உயர் ஞானம், தனிஞானம்
VERSE_TAG_PATTERNS = [
    # Wisdom categories
    'உயர் ஞானம்',
    'தனிஞானம்',

    # Deity invocations (துதி)
    'விநாயகர் துதி',
    'சரஸ்வதி துதி',
    'சிவபெருமான் துதி',
    'சுப்பிரமணியர் துதி',
    ...
    # Poetic forms - these describe the meter/form of the verse
    'விருத்தம்',  # Matches: எண்சீர் விருத்தம், etc.
    'கலித்துறை',  # Matches: கட்டளைக் கலித்துறை, etc.
    'கொச்சகம்',  # Matches: தரவு கொச்சகம், etc.
    'வெண்பா',  # Matches: நேரிசை வெண்பா, etc.
    'தாழிசை',  # Poetic form
    'களிப்பு',  # Poetic form
]

# Section name replacements: Convert generic "Main Text" to "பாடல் தொகுப்பு"
SECTION_NAME_REPLACEMENTS = {
    'Main Text': 'பாடல் தொகுப்பு',
}
