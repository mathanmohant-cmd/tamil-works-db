...
# -*- coding: utf-8 -*-
"""
Thiruvarutpa Uran Adigal Edition Metadata
==========================================

Work: Thiruvarutpa - Uran Adigal Edition (திருவருட்பா - ஊரன் அடிகள் பதிப்பு)
...
Import Script: thiruvarutpa_uran_bulk_import.py
Delete Script: delete_thiruvarutpa_uran.py
Source File: 6_பக்தி இலக்கியம்/21.திருவருட்பா-ஊரன் அடிகள் பதிப்பு.txt
"""
...
WORK_METADATA = {
    ...
    'description': 'Thiruvarutpa (Uran Adigal Edition) by Ramalinga Swamigal (Vallalar) - Songs of Divine Grace',
    'canonical_order': 504,
    'position_in_collection': 5,  # Position 5 in collection 323 (after Balakrishnapillai edition)
    ...
    'metadata': {
        ...
        'edition': 'Uran Adigal Edition',
        'edition_tamil': 'ஊரன் அடிகள் பதிப்பு',
...
FILE_INFO = {
    ...
    'source_file': '21.திருவருட்பா-ஊரன் அடிகள் பதிப்பு.txt',
    'file_number': 21,
    'structure_markers': {
