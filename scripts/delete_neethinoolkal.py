...
# -*- coding: utf-8 -*-
"""
Delete all 21 ethical literature works (நீதிநூல்கள்) and collection 325

Works deleted:
1. ஆத்திசூடி (Aathichudi)
2. கொன்றைவேந்தன் (Konrai Venthan)
3. மூதுரை (வாக்குண்டாம்) (Moodhurai - Vaakkundaam)
4. நல்வழி (Nalvazhi)
5. வெற்றி வேற்கை (நறுந்தொகை) (Vetri Vetkai - Narunthokai)
6. உலக நீதி (Ulaga Neethi)
7. நீதிநெறி விளக்கம் (Neethineeri Vilakkam)
8. அறநெறிச்சாரம் (Araneri Chaaram)
...
16. நன்மதி வெண்பா (Nanmadhi Venpa)
17. அருங்கலச்செப்பு (Arungalach Cheppu)
18. முதுமொழிமேல் வைப்பு (Mudhumozhimael Vaippu)
19. புதிய ஆத்திசூடி (Pudhiya Aathichudi)
20. இளையார் ஆத்திசூடி (Ilaiyaar Aathichudi)
21. திருக்குறள் குமரேச வெண்பா (Thirukkural Kumaresa Venpa)

Usage:
    python delete_neethinoolkal.py [database_url]

Examples:
    python delete_neethinoolkal.py
    python delete_neethinoolkal.py postgresql://postgres:postgres@localhost/tamil_literature
"""
...
WORK_NAMES = [
    'Aathichudi',
    'Konrai Venthan',
    'Moodhurai (Vaakkundaam)',
    'Nalvazhi',
    'Vetri Vetkai (Narunthokai)',
    'Ulaga Neethi',
    'Neethineeri Vilakkam',
    'Araneri Chaaram',
    'Neethi Nool',
    'Nanneri',
    'Neethi Chudamani',
    ...
    'Nanmadhi Venpa',
    'Arungalach Cheppu',
    'Mudhumozhimael Vaippu',
    'Pudhiya Aathichudi',
    'Ilaiyaar Aathichudi',
    'Thirukkural Kumaresa Venpa'
]
...
def main():
    ...
    print("=" * 70)
    print("Delete நீதிநூல்கள் (Ethical Literature)")
    print("Collection 325: Twenty-One Ethical Literature Works")
    print("=" * 70)
