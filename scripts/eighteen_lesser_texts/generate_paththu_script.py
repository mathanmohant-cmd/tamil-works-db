...
# -*- coding: utf-8 -*-
"""
Generator for Muthumozhikkanchi paththu structure import script.
Creates import/delete pair for paththu-based organization (groups of ten).
"""
...
def generate_paththu_import_script(work_key, metadata):
    """Generate import script for paththu structure work"""
...
def main():
    print("="*70)
    print("  Generating Paththu Structure Script (Muthumozhikkanchi)")
    print("="*70)

    works_dir = Path(__file__).parent / 'works'

    work_key = 'muthumozhikkanchi'
    if work_key in WORK_METADATA:
        metadata = WORK_METADATA[work_key]

        # Generate import script
        import_script = generate_paththu_import_script(work_key, metadata)
    ...
    print(f"\n✓ Generated Muthumozhikkanchi paththu structure script pair (2 scripts)")
