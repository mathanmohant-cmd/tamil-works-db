...
# -*- coding: utf-8 -*-
"""
Generator for thinai structure import scripts.
Creates import/delete pairs for all 5 thinai works.
"""
...
def generate_thinai_import_script(work_key, metadata):
    """Generate import script for thinai structure work"""
...
def main():
    print("="*70)
    print("  Generating Thinai Structure Scripts")
    print("="*70)
    ...
    print("\nGenerating thinai structure scripts...")
    for work_key in thinai_works:
        if work_key in WORK_METADATA:
            metadata = WORK_METADATA[work_key]

            # Generate import script
            import_script = generate_thinai_import_script(work_key, metadata)
    ...
    print(f"\n✓ Generated {len(thinai_works)} thinai structure work pairs ({len(thinai_works)*2} scripts)")
