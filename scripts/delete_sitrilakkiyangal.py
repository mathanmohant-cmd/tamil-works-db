...
# -*- coding: utf-8 -*-
"""
Delete all 20 minor literary works (சிற்றிலக்கியங்கள்) and collection 326

Works deleted:
1. அபிராமி அந்தாதி (Abhirami Andhadhi)
2. அழகர் கிள்ளை விடுதூது (Azhagar Killai Viduthootu)
3. கச்சிக் கலம்பகம் (Kachchi Kalambagam)
4. கலிங்கத்துப்பரணி (Kalingathu Parani)
5. காசிக் கலம்பகம் (Kasi Kalambagam)
6. காவடிச் சிந்து (Kavadi Chindu)
7. குசேலோபாக்கியானம் (Kuselopakyanam)
8. குமரேச சதகம் (Kumaresa Sadhagam)
9. தக்கயாகப்பரணி (Thakayaga Parani)
10. தஞ்சைவாணன் கோவை (Thanjai Vanan Kovai)
11. தமிழ்விடு தூது (Thamizh Vidu Thootu)
12. திருக்குற்றாலக் குறவஞ்சி (Thirukkutrala Kuravanji)
13. நந்திக் கலம்பகம் (Nandhi Kalambagam)
14. நளவெண்பா (Nala Venba)
15. பாண்டிக்கோவை (Pandi Kovai)
16. பெத்லகேம் குறவஞ்சி (Bethlakema Kuravanji)
17. மதுரை மீனாட்சியம்மை பிள்ளைத் தமிழ் (Madurai Meenakshiyammai Pillai Thamizh)
18. மதுரைக் கலம்பகம் (Madurai Kalambagam)
19. முக்கூடற் பள்ளு (Mukkudal Pallu)
20. மூவருலா (Muvarula)
...
WORK_NAMES = [
    ...
    'Thanjai Vanan Kovai',
    'Thamizh Vidu Thootu',
    'Thirukkutrala Kuravanji',
    'Nandhi Kalambagam',
    'Nala Venba',
    'Pandi Kovai',
    'Bethlakema Kuravanji',
    'Madurai Meenakshiyammai Pillai Thamizh',
    'Madurai Kalambagam',
    'Mukkudal Pallu',
    'Muvarula'
]
...
def main():
    ...
    print("Collection 326: Twenty Minor Literary Works")
    print("=" * 70)
