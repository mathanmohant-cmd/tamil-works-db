...
# -*- coding: utf-8 -*-
"""
Delete Thirumanthiram work and collection

This script deletes:
- Thirumanthiram work (திருமந்திரம்)
- Collection 32110 (பத்தாம் திருமுறை - 10th Thirumurai)

Usage:
    python delete_thirumanthiram.py [database_url]
"""
...
def delete_thirumanthiram(connection_string):
    """Delete Thirumanthiram work and collection"""
    print("\n" + "="*70)
    print("  DELETE THIRUMANTHIRAM")
    print("="*70)
    ...
    try:
        ...
        cursor.execute("""
            ...
            WHERE wc.collection_id = 32110
        """)
        work_row = cursor.fetchone()

        if not work_row:
            print("\n✗ Thirumanthiram work not found")
            return False
        ...
        print(f"  - Collection 32110 (பத்தாம் திருமுறை - 10th Thirumurai)")
        ...
        # 2. Delete collection
        print("  Deleting collection 32110 (பத்தாம் திருமுறை)...")
        cursor.execute("DELETE FROM collections WHERE collection_id = 32110")

        conn.commit()
        print("\n✓ Successfully deleted Thirumanthiram work and collection")
        return True
...
def main():
    ...
    if delete_thirumanthiram(db_connection):
        print("\n✓ Deletion complete")
        sys.exit(0)
    else:
        print("\n✗ Deletion failed")
