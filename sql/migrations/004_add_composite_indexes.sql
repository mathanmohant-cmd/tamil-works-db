...
-- Date: 2026-01-01
-- Purpose: Improve query performance for collection sort and filtered searches
-- Note: Removed invalid idx_verses_chronology_sort (verses table doesn't have chronology_start_year)

-- 1. Composite index for collection sort queries
...
-- 2. Composite index for filtered word searches
...
-- 3. Additional composite index for word_root searches
